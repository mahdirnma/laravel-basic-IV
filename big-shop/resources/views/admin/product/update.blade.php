                ...
                <form action="{{route('product.edit',compact('product'))}}" method="post" class="w-full h-full flex flex-row-reverse">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20 relative">
                        ...
                        <div class="w-full h-auto flex flex-row-reverse justify-start pt-4">
                            ...
                            <input type="text" name="main_pic" id="main_pic" value="{{$product->picture->main_picture}}" class="w-2/5 h-8 border border-gray-400 rounded outline-0 p-2">
                    ...
                    <div class="w-1/2 h-full flex flex-col items-end pr-20">
                        ...
                        <div class="w-full h-auto flex flex-row-reverse justify-start pt-4 mb-6">
                            ...
                            <input type="text" name="pic1" id="pic1" value="{{$product->picture->picture_1}}" class="w-2/5 h-8 border border-gray-400 rounded outline-0 p-2">
                            @if($errors->has('pic1'))
                        ...
                        <div class="w-full h-auto flex flex-row-reverse justify-start pt-4">
                            ...
                            <input type="text" name="pic2" id="pic2" value="{{$product->picture->picture_2}}" class="w-2/5 h-8 border border-gray-400 rounded outline-0 p-2">
                            @if($errors->has('pic2'))
