    ...
    <div class="w-full h-[88%] bg-gray-200 flex items-center justify-center">
        <div class="w-[90%] h-5/6 bg-white rounded-xl pt-3 flex flex-col items-center">
            <div class="w-[90%] h-1/5 flex justify-between items-center border-b">
                <a href="{{route('product.create')}}" class="px-10 py-3 rounded-xl font-light text-white bg-gray-800">افزودن محصول +</a>
            ...
            <div class="w-[90%] h-3/5 flex justify-between items-center">
                <table class="w-full min-h-full border border-gray-400">
                    ...
                    <tr class="h-12 border border-gray-400 border-b-2 border-b-gray-400">
                        ...
                        <td class="text-center">تگ ها</td>
                        <td class="text-center">دسته بندی</td>
                        <td class="text-center">موجودی</td>
